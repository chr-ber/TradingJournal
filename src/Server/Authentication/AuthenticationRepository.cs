...
internal class AuthenticationRepository : IAuthenticationRepository
{
   ...
   public async Task<ServiceResponse<int>> Register(UserRegistration registration)
   {
      ...
      CreatePasswordHash(registration.Password, out var passwordHash, out var passwordSalt);
   ...
   private string CreateToken(User user)
   {
      ...
      var daysToExpire = double.Parse(_configuration.GetSection("JavaWebTokenSettings:DaysToExpire").Value);
