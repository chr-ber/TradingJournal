...
namespace TradingJournal.Infrastructure.Server.Persistence.Migrations
{
    ...
    [Migration("20220216101454_Added executions and contracts")]
    partial class Addedexecutionsandcontracts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradingJournal.Domain.Entities.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradingJournal.Domain.Entities.Trade", b =>
                {
                    b.HasOne("TradingJournal.Domain.Entities.Contract", "Contract")
                        .WithMany()
