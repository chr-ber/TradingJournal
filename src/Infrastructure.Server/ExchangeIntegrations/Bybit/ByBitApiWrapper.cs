...
using TradingJournal.Application.Common.Models.ByBit;

namespace TradingJournal.Infrastructure.Server.ExchangeIntegrations.Bybit;

public class ByBitApiWrapper : IByBitApiWrapper
{
    private WebSocketConnection _wsConnectionInverse;
    private WebSocketConnection _wsConnectionUsdt;

    public event Func<List<WebSocketExecution>, IByBitApiWrapper, bool, decimal, Task> OnReceivedExecution;
